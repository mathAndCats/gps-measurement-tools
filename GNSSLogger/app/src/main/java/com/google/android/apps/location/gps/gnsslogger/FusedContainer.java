...
public class FusedContainer implements
        LocationListener,
   ...
   // Button btnFusedLocation;
    ...
    private boolean mRegisterRequestFlag;

    public FusedContainer(Context applicationContext,  GnssListener... loggers) {
        mContext = applicationContext;
        mRegisterRequestFlag = false;
   ...
   /* public void onStart() {
    ...
    public void onConnected(Bundle bundle) {
        ...
        connectedFlag = true;
        if (mRegisterRequestFlag) registerFusedLocation();
    }

    protected void registerFusedLocation() {
        mRegisterRequestFlag = true;

        if(connectedFlag && mRegisterRequestFlag) {
   ...
   /* @Override
    ...
    protected void unregisterFusedLocation() {
